...
%f(1) is phi1. f(2) is ph2-or phi dot if you like. f(3) is a.
...
%the scalar field.
fprime(2) = -3*H(f(3), f(1), f(2), par)*f(2) - Vexppreprime(f(1), par) ;

%adot is determined from the friedmann equaiton
fprime(3) = f(3)*H(f(3), f(1), f(2), par);
